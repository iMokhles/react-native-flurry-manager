...
public class RNImFlurryManagerNativeAdView extends LinearLayout {
    ...
    private static final String kLogTag = "RNImFlurryManagerNativeAdView";
    ...
    public RNImFlurryManagerNativeAdView(ThemedReactContext themedReactContext) {
    ...
    private FlurryAdNative initializeFlurryAd(String adSpaceName) {
        ...
        RNImFlurryManagerNativeAdView.ReactNativeFlurryAdNativeListener listener = new RNImFlurryManagerNativeAdView.ReactNativeFlurryAdNativeListener();
    ...
    class ReactNativeFlurryAdNativeListener implements FlurryAdNativeListener {
        ...
        public void onFetched(FlurryAdNative flurryAdNative) {
            ...
            flurryAdNative.setTrackingView(RNImFlurryManagerNativeAdView.this);
